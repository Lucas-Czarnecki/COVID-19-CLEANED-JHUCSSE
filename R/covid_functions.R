...
# Clean Admin2 names.
dirty_admin_names <- c("Yolo County", "Williamson County", "Do<f1>a Ana",  "New York City", "New York County", "Queens County")
clean_admin_names <- c("Yolo", "Williamson", "Dona Ana", "New York", "New York", "Queens") 
